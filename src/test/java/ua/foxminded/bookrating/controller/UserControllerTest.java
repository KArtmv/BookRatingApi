...
@Import({UserModelAssembler.class, RatingOfBookModelAssembler.class, SimpleBookModelAssembler.class})
...
class UserControllerTest {
    ...
    @Test
    void getRatedBooksByUser() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/users/{id}/rated-books", USER_DATA.getId())).andDo(print())
                .andExpectAll(
                        ...
                        jsonPath("$._embedded.ratingModelList[0].book.publicationYear").value(BOOK_DATA.getPublicationYear()),
