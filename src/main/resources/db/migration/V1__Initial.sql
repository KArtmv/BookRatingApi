CREATE SEQUENCE IF NOT EXISTS author_id_seq START WITH 1 INCREMENT BY 10000;

CREATE SEQUENCE IF NOT EXISTS book_id_seq START WITH 1 INCREMENT BY 10000;

CREATE SEQUENCE IF NOT EXISTS image_id_seq START WITH 1 INCREMENT BY 10000;

CREATE SEQUENCE IF NOT EXISTS publisher_is_seq START WITH 1 INCREMENT BY 10000;

CREATE SEQUENCE IF NOT EXISTS rating_id_seq START WITH 1 INCREMENT BY 10000;

CREATE SEQUENCE IF NOT EXISTS user_id_seq START WITH 1 INCREMENT BY 10000;
