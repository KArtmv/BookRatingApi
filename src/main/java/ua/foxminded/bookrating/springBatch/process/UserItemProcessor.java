...
import ua.foxminded.bookrating.dto.UserRawDataDto;
import ua.foxminded.bookrating.persistance.entity.User;

@Component
public class UserItemProcessor implements ItemProcessor<UserRawDataDto, User> {

    @Override
    public User process(UserRawDataDto item) {
